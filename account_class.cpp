//write a cpp programme to create an account class.The class should have the following functions
//1.function to create an account
//2.function to deposit an amount to an account
//3.function to withdraw amount from account
//4.function to display the balance available
#include<iostream>
using namespace std;
class account
{
